...
/** 犬種制限についての絵本（絵本v3.0）— 先頭番号順（フォルダ内の実ファイル名で参照） */
const STORY_BOOK_BASE = "/srory-book/絵本v3.0"
const storyBookImages = [
  `${STORY_BOOK_BASE}/00.avif`,
  `${STORY_BOOK_BASE}/01.avif`,
  `${STORY_BOOK_BASE}/02.avif`,
  `${STORY_BOOK_BASE}/03-fd73e99f-8a75-4ecd-b525-3966269a6375.avif`,
  `${STORY_BOOK_BASE}/04-c7d48d3d-2cf5-4293-85b1-eded4d621564.avif`,
  `${STORY_BOOK_BASE}/4.1__2_-64f1167c-44c5-4dd7-9be6-4ca6249372da.avif`,
  `${STORY_BOOK_BASE}/05-2be80df1-b5dc-4fc0-8a0d-d571b675eb90.avif`,
  `${STORY_BOOK_BASE}/06-dfd5c2e2-7d9e-48cc-ae83-5dc1a2978d37.avif`,
  `${STORY_BOOK_BASE}/07-78acc76f-451b-4491-87b1-c0874acad825.avif`,
  `${STORY_BOOK_BASE}/08-eb96a815-0169-42e8-83ab-bfaa33da0d63.avif`,
  `${STORY_BOOK_BASE}/09-c09bcb79-3842-4644-aac5-5d3a0569559e.avif`,
]

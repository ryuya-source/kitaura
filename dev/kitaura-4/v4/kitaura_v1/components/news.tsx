...
const ALL_ITEMS: NewsItem[] = [
  {
    ...
    category: "お知らせ",
    title: "「第3回RVパークアワード」を受賞いたしました！",
    body: (
      <>
        いつも当施設をご利用いただき、誠にありがとうございます。
        <br />
        この度、一般社団法人日本RV協会が主催する「第3回RVパークアワード」において、<strong>当施設が【10位】入賞</strong>いたしましたことをご報告いたします。
        <br />
        <br />
        この賞は、一般ユーザーの皆様からの投票によって「最も素敵だと思うRVパーク」が選ばれるものです。日頃より応援してくださる皆様、そして実際に足を運んでくださる皆様のおかげで、このような光栄な賞をいただくことができました。心より感謝申し上げます。
        <br />
        <br />
        今回の受賞を励みに、これからも皆様に快適で思い出に残る車中泊体験を提供できるよう、より一層のサービス向上に努めてまいります。皆様のお越しを、スタッフ一同心よりお待ちしております。
      </>
    ),
  },
  {

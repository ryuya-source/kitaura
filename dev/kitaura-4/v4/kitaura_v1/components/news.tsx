...
const ALL_ITEMS: NewsItem[] = [
  {
    ...
    body: (
      <>
        平素は格別のご高配を賜り、厚く御礼申し上げます。サイト1につきまして、オープン当初より特別価格にてご提供してまいりましたが、建築材料費・備品購入費・光熱費等の著しい高騰により、サービスの品質維持と快適な環境のご提供のため、誠に心苦しいお願いではございますが、2026年1月1日よりサイト1のご利用料金を改定させていただく運びとなりました。
        <br />
        <br />
        あわせて、これまで「3歳以下は無料」としておりました料金体系を改定し、2026年1月1日以降のご予約・ご利用分より、3歳以下のお子様も大人の方と同じ料金とさせていただきます。何卒ご了承ください。
        <br />
        <br />
        今回の価格改定前に既にご予約をいただいておりますお客様のご利用分につきましては、ご予約を承った時点の料金にて、変わらずご利用いただけます。既存のご予約料金への影響は一切ございませんので、ご安心ください。引き続き変わらぬご愛顧を賜りますよう、心よりお願い申し上げます。
      </>
    ),
  },
  {
    ...
    category: "お知らせ",
    title: "【第3回 RVパークアワード】10位入賞🏆",
    body: (
      <>
        3区画しかない小さなパークですが、多くの皆様からご投票をいただき、驚きと感謝の気持ちでいっぱいです。
        <br />
        <br />
        Openして1年という節目にいただいた素敵な賞を励みに、これからも皆様の旅の思い出に彩を添えられるようなパークでありたいと思います。
        <br />
        <br />
        皆様とのご縁に、心より感謝申し上げます。
      </>
